...
describe("Customers",function(){
    describe("POST /signin",function () {
        before("Before making the authentication we need to create a new customer",function(done){
            ...
            .send(mock.customer_with_a_valid_body)
        ...
        it("Success: customer is an existing user",function(done){
            ...
            .send({
                email: mock.customer_with_a_valid_body.email,
                password: mock.customer_with_a_valid_body.password
            })
            .end(function(err,res){
                ...
                res.body.success.should.equal(true);
                message.welcome.should.equal('Welcome ' + mock.customer_with_a_valid_body.first_name);
